            ...
            <div class="well">
                ...
                <form id="formModifierGoodie" method="post">
                    ...
                    <div class="form-group"> <!-- ID du goodie -->
                        ...
                        <input class="form-control" id="formModifierGoodie_idGoodie" type="text" value="<?php echo ID ?>" name="formModifierGoodie_idGoodie" readonly>
                    </div>
                    <div class="form-group"> <!-- Titre du goodie -->
                        <label for="formModifierGoodie_titreGoodie">Titre du goodie</label>
                        <input class="form-control" id="formModifierGoodie_titreGoodie" type="text" value="<?php echo TITRE ?>" placeholder="Titre" name="formModifierGoodie_titreGoodie">
                    </div>
                    ...
                    <div class="form-group"> <!-- Prix adhérent -->
                        ...
                        <input class="form-control" id="formModifierGoodie_prixAdhérentEuro" type="number" value="<?php echo PRIX_AD_EURO ?>" min="0" name="formModifierGoodie_prixAdhérentEuro" placeholder="Euros">
                        <small class="form-text text-muted">Euros</small>
                        <input class="form-control" id="formModifierGoodie_prixAdhérentCentimes" type="number" value="<?php echo PRIX_AD_CENTIMES ?>" min="0" max="99" name="formModifierGoodie_prixAdhérentCentimes" placeholder="Centimes">
                    ...
                    <div class="form-group"> <!-- Prix non-adhérent -->
                        ...
                        <input class="form-control" id="formModifierGoodie_prixNonAdhérentEuro" type="number" value="<?php echo PRIX_NAD_EURO ?>" min="0" name="formModifierGoodie_prixNonAdhérentEuro" placeholder="Euros">
                        <small class="form-text text-muted">Euros</small>
                        <input class="form-control" id="formModifierGoodie_prixNonAdhérentCentimes" type="number" value="<?php echo PRIX_NAD_CENTIMES ?>" min="0" max="99" name="formModifierGoodie_prixNonAdhérentCentimes" placeholder="Centimes">
                        <small class="form-text text-muted">Centimes</small>
                    </div>
                    <div class="form-group"> <!-- Description du goodie -->
                        <label for="formModifierGoodie_descGoodie">Description du goodie</label>
                        <textarea class="form-control" id="formModifierGoodie_descGoodie" placeholder="Description du goodie" name="formModifierGoodie_descGoodie" rows="20"><?php echo DESC ?></textarea>
