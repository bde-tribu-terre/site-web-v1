            ...
            <div class="well">
                ...
                <form id="formModifierArticle" method="post">
                    ...
                    <div class="form-group"> <!-- ID de l'article -->
                        ...
                        <input class="form-control" id="formModifierArticle_idArticle" type="text" value="<?php echo ID ?>" name="formModifierArticle_idArticle" readonly>
                    </div>
                    <div class="form-group"> <!-- Titre de l'article -->
                        <label for="formModifierArticle_titre">Titre de l'article</label>
                        <input class="form-control" id="formModifierArticle_titre" type="text" value="<?php echo TITRE ?>" placeholder="Titre" name="formModifierArticle_titre">
                    </div>
                    ...
                    <div class="form-group"> <!-- Texte -->
                        ...
                        <textarea class="form-control" id="formModifierArticle_texte" placeholder="Texte de l'article" name="formModifierArticle_texte" rows="20"><?php echo TEXTE ?></textarea>
