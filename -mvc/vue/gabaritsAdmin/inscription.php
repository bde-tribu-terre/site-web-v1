            ...
            <div class="well">
                ...
                <form id="formConnexion" method="post" onsubmit="return verifForm(this);">
                    ...
                    <p> <!-- Login -->
                        ...
                        <input onblur="verifNonVide(this);" oninput="this.value = this.value.toLowerCase();" class="form-control" id="formInscription_login" type="text" name="formInscription_login" placeholder="Choisir le login">
