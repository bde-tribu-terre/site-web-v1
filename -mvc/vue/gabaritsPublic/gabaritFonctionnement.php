        ...
        <div class="col-sm-10">
            <div class="text-justify">
                <p>
                    ...
                    Quels sont les différents acteurs ? (adhérents/membres/bureau/...)
                    Qu'est-ce que l'AG ?
                    Il peut y avoir des liens, des images, des trucs dans le texte etc...
                </p>
                <p>
                    (Texte temporaire que j'avais fait)
                </p>
                <p>
                    Les statuts de l'association sont, en quelque sorte, le règlement de conduite que doit suivre l'association et ses
                    membres.<br>
                ...
                <h3>
                    <a href="<?php echo $prefixe . 'association/fonctionnement/2019-03-12-Statuts.pdf' ?>">Consulter les statuts.</a>
                </h3>
            </div>
        </div>
        <div class="col-sm-1"></div>
